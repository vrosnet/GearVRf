...
public class GVRTexture extends GVRHybridObject {
     ...
     * each and every one call will wait for about 16ms.
     * 
    ...
    private void idAvailable(final int id) {
        android.util.Log.i("mmarinov", "idAvailable");
        mTextureId = id;
        if (null != mFuture) {
            mFuture.signal();
        }
    ...
    private final class RealFuture extends FutureBase {
        ...
        void signal() {
            mLock.lock();
            try {
                android.util.Log.i("mmarinov", "signalAll");
