...
abstract class GVRCameraRigBase extends GVRComponent implements PrettyPrint {
    ...
    public GVRCameraRigBase(GVRContext gvrContext) {
    ...
    public GVRCameraRigBase(GVRContext gvrContext, GVRSceneObject owner) {
        super(gvrContext, NativeCameraRigBase.ctor());
    ...
    /** Constructor helper */
    private final void init(GVRContext gvrContext) {
        /*
